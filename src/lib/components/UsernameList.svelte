  ...
  <div class="flex flex-col gap-4">
    ...
    <div class="flex flex-wrap flex-1 gap-4 content-baseline justify-center">
      {#each usernames as { username }}
        <div
          class="flex justify-between bg-slate-700 items-center rounded-xl hover:bg-slate-600 duration-500 self-baseline"
        >
          <a
          ...
          <button
            ...
            type="button"
            class="py-2 pr-1 pl-1 hover:text-red-400 duration-200"
          >
            <X class="" />
          </button>
        </div>
